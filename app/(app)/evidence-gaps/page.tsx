...
export default function Page() {
  return (
    <FeaturePage
      ...
      subtitle="Defect Reduction"
      description="Prioritized missing evidence queue organized by impact, urgency, and body system to increase claim strength and reduce denial risk."
      metrics={[
