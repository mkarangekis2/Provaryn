...
export default function Page() {
  return (
    <FeaturePage
      title="Claim Builder Workspace"
      subtitle="Assembly Workspace"
      description="Assemble selected conditions, evidence links, and strategy context into a cohesive, reviewable claim package."
      metrics={[
