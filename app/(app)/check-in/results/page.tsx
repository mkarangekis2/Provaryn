...
export default function Page() {
  return (
    <FeaturePage
      title="Weekly Check-In Results"
      subtitle="Insight Review"
      description="Review AI-detected shifts, trend deltas, and recommended documentation actions based on newly submitted symptom records."
      metrics={[
