...
export default function Page() {
  return (
    <FeaturePage
      title="Career Reconstruction Results"
      subtitle="First Insight Moment"
      description="Review reconstructed timeline, possible claim areas, evidence gaps, and optional premium reconstruction unlock."
      metrics={[
