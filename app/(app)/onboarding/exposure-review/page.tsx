...
export default function Page() {
  return (
    <FeaturePage
      title="Exposure Mapping Review"
      subtitle="AI Validation"
      description="Review AI-inferred occupational and environmental exposure patterns, adjust details, and confirm service context."
      metrics={[
