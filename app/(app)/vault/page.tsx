...
export default function Page() {
  return (
    <FeaturePage
      ...
      subtitle="Secure Document Hub"
      description="Securely upload and organize records with condition and timeline context, AI summaries, signed-access controls, and searchable metadata."
      metrics={[
