...
export default function Page() {
  return (
    <FeaturePage
      title="Claim Package Readiness Review"
      subtitle="Go/No-Go"
      description="Validate ready conditions, unresolved blockers, forms status, and attachment coverage before packaging and submission guidance."
      metrics={[
