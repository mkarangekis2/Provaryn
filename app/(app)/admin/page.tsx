...
export default function Page() {
  return (
    <FeaturePage
      ...
      subtitle="Cohort Intelligence"
      description="View readiness distribution, transition risk, completion metrics, and high-level performance across authorized cohorts."
      metrics={[
