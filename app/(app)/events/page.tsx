...
export default function Page() {
  return (
    <FeaturePage
      title="Event Logging"
      subtitle="Incident Capture"
      description="Log injuries, blast exposures, appointments, profile updates, diagnosis changes, medication events, and performance impacts."
      metrics={[
