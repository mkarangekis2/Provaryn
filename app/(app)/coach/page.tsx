...
export default function Page() {
  return (
    <FeaturePage
      ...
      subtitle="Permission-Scoped Oversight"
      description="Monitor assigned users, readiness trends, evidence gaps, and intervention recommendations under explicit user consent."
      metrics={[
