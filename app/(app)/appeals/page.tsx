...
export default function Page() {
  return (
    <FeaturePage
      title="Appeals & Increase Opportunities"
      subtitle="Optimization Pipeline"
      description="Identify denied, underrated, and unfiled-secondary opportunities to improve long-term compensation outcomes."
      metrics={[
